<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="cards.aspx.cs" Inherits="TarotWebform.WebForm2" %>
    ...
    <div id="contentwrapper">
        ...
        <div class="text">
            ...
            <p>
                ...
                This Tarot card shows the highest potential for your life, reaching a state
                of renewal and new beginnings, where each day is an adventure and each moment
                is lived to the fullest. The Fool card represents the beginning of all creativity
                and a desire to accomplish new goals (or to, at least, start the process of working
                towards those goals). The Fool indicates that anything can happen and the opportunities
                are just waiting to be taken advantage of.
            </p>

            <p>
                In a Tarot reading, the Fool represents the need to set forth on a new journey,
                one that is completely unknown and will take you to uncharted territories.
                The Fool is all about new experiences, personal growth, development and adventure.
                The Fool Tarot card asks you to take a ‘leap of faith’ and to trust in the Universe
                in that if you begin a new journey, you will find success. This Fool lives a carefree
                life, free from worry and anxiety. He does not seem to mind if he does not really
                know what lies ahead.
            </p>
            <p>
                The Fool Tarot card may represent a choice to be made—one of vital importance.
                However, there are always many different options available and the choice must be made wisely.
                If you are facing a decision or moment of doubt, the Fool encourages you to believe in yourself
                and follow your heart no matter how crazy or foolish your impulses may seem. This is a time when
                you need to truly ‘believe’ and have faith in where the Universe is taking you.
            </p>
            <p>
                The Fool is an excellent Tarot card to meditate on if you are experiencing a lot of fear in your
                life. The Fool enhances courage, risk-taking and the creative expression needed to open up new
                areas in your life.
            </p>
            <p>
                The Fool is always whole, healthy and without fear. He is the spirit of who we are,
                the spirit expressed and experienced as wonder, awe, curiosity and anticipation.
                We never know what is in the future but like the Fool we must blindly go forward.
        ...
        <div class="cardholder">
            <div class="card">
                ...
                <img src="imgcards/illuminati-aceofpentacles.jpg" alt="ace of pentacles" width="300" height="500"/>
        ...
        <div class="text">
            ...
            <p>
                The Ace of Pentacles, like the Aces of the other suits, is representative of new beginnings, 
                fresh energy, and inspiration. In this case, the Pentacles are equivalent to the alchemical 
                element of Earth, and therefore symbolise the material world and things associated with matter 
                and the body. Pentacles also represent money and the financial concerns that you may have at 
                the time of your reading. Thus, the Ace of Pentacles indicates the beginning of new energy and 
                revitalised interest in the material or financial areas of your life. This card may represent 
                the beginning of new investments or the willingness to undertake a new business venture. 
                There is also the possible indication of a legacy or influx of money from an unexpected source. 
                The Ace of Pentacles heralds a feeling of prosperity and abundance and should be accepted joyfully. 
                It is a very positive card in general. 
            </p>

            <p>
                The Ace of Pentacles is symbolic of wealth, not just in the financial sense but also in a more holistic sense. 
                You may see new opportunities come your way to generate a new source of income, or you may be lucky enough to 
                receive a financial gift or windfall. On a broader level, this Ace indicates abundance in all areas of your life 
                and a general feeling that you are indeed blessed and deserving of everything that comes your way. 
                Operate by the Law of Attraction, and send out positive energy into the Universe so that you may receive abundance in return. 
            </p>
            <p>
                The Ace of Pentacles is about manifestation of your goals, and that you are moving into a more positive state of mind 
                about what you are capable of achieving. Your ideas are ready to be turned into something tangible. Figure out what 
                will work and make it a reality. Thus, the Ace of Pentacles sees you starting to map out how exactly you will achieve 
                your goals, by creating targeted action plans and getting those actions underway. There are opportunities that are 
                becoming available to you that will help you to manifest your goals and realise your inner potential, whilst at the 
                same time generate some level of income and financial support. You are beginning to see that the world is indeed your 
                oyster and that through careful planning, you can manifest your true goals and desires. 
            </p>
            <p>
                The Ace of Pentacles can suggest that we need to introduce something new into the equation. Rather than let things remain as they are, 
                and hope they work themselves out, the Ace of Pentacles suggests you throw something new into the mix. Consider something that is 
                out-of-character or something you might not ordinarily do, or get around to doing. For instance, you might consider joining a club, 
                taking a class to learn new skills or maybe even picking up a couple of books to learn how to build a new business.
            </p>
            </div>
            </div>
        <hr />
            ...
            <div class="card">
                ...
                <img src="imgcards/illuminati-death.jpg" alt="death tarot card" width="300" height="500"/>
        ...
        <hr />
            ...
            <div class="card">
                ...
                <img src="imgcards/illuminati-fiveofwands.jpg" alt="The five of Wands tarot card" width="300" height="500"/>
        ...
        <hr />
            ...
            <div class="card">
                ...
                <img src="imgcards/illuminati-nineofpentacles.jpg" alt="The Nine of Pentacles tarot card" width="300" height="500"/>
        ...
        <hr />
            ...
            <div class="card">
                ...
                <img src="imgcards/illuminati-princeofswords.jpg" alt="The Prince of Swords tarot card" width="300" height="500"/>
        ...
        <div class="text">
            ...
            <div class="card">
                ...
                <img src="imgcards/illuminati-sixofcups.jpg" alt="The Six of Cups tarot card" width="300" height="500"/>
        ...
        <hr />
            ...
            <div class="card">
                ...
                <img src="imgcards/illuminati-theworld.jpg" alt="The World tarot card" width="300" height="500"/>
        ...
        <div class="text">
            ...
            <div class="card">
                ...
                <img src="imgcards/illuminati-sixofswords.jpg" alt="The Six of Swords tarot card" width="300" height="500"/>
